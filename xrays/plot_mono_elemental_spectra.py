...
plt.plot(xg_fe_1, yg_fe_1, label="K-alpha")
plt.plot(xg_fe_2, yg_fe_2, label="K-beta")
plt.grid()
plt.legend()
plt.xlim([0, 15])
...
plt.plot(xg_ni_1, yg_ni_1, label="K-alpha")
plt.plot(xg_ni_2, yg_ni_2, label="K-beta")
plt.grid()
plt.legend()
plt.xlim([0, 15])
plt.xlabel("Energy (keV)")
...
plt.plot(xg_cu_1, yg_cu_1, label="K-alpha")
plt.plot(xg_cu_2, yg_cu_2, label="K-beta")
plt.grid()
plt.legend()
plt.xlim([0, 15])
plt.xlabel("Energy (keV)")
...
plt.plot(xg_sn_1, yg_sn_1, label="L-beta")
plt.grid()
plt.legend()
plt.xlim([0, 15])
plt.xlabel("Energy (keV)")
...
plt.plot(xg_cd_1, yg_cd_1, label="K-alpha")
plt.plot(xg_cd_2, yg_cd_2, label="L-alpha")
plt.grid()
plt.legend()
plt.xlim([0, 25])
plt.xlabel("Energy (keV)")
...
plt.plot(xg_in_1, yg_in_1, label="L-alpha")
plt.grid()
plt.legend()
plt.xlim([0, 15])
plt.xlabel("Energy (keV)")
...
plt.plot(xg_zr_1, yg_zr_1, label="K-alpha")
plt.plot(xg_zr_2, yg_zr_2, label="L-alpha")
plt.grid()
plt.legend()
plt.xlim([0, 20])
plt.xlabel("Energy (keV)")
